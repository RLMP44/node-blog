...
var bio = [
    `Alora Faelan is a rising star in the realms of speculative fiction and high fantasy. Born in the quiet coastal town of Atheria, she spent her childhood weaving intricate tales inspired by the crashing waves and ancient forests that surrounded her.`,
    `Faelan's journey into writing began with a simple question posed by her grandmother: "What if the stars sang?" This sparked a lifelong fascination with the hidden possibilities within the ordinary world, a theme that permeates her work.`,
    `While her debut novel, The Whispering Stones, catapulted her into the literary spotlight, Faelan is no stranger to the written word. Her short stories have graced the pages of numerous speculative fiction magazines, including "Realms of Enchantment" and "Tales of the Unseen." These shorter works, often praised for their lyrical prose and innovative concepts, have garnered her a dedicated following and several nominations for the prestigious Sunspear Award.`,
